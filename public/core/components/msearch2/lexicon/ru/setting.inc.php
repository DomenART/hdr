...
$_lang['setting_mse2_index_split_words'] = 'Разбивка слов индекса';
$_lang['setting_mse2_index_split_words_desc'] = 'Регулярное выражение для разбивки предложений на слова. Не меняйте эту настройку, если не знаете, что делаете.';
...
$_lang['setting_mse2_old_search_algorithm'] = 'Старый алгоритм поиска';
$_lang['setting_mse2_old_search_algorithm_desc'] = 'Включить старый алгоритм поиска, который выводит тем больше результатов, чем больше слов в запросе.';
